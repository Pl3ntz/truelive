...
//     `window.TrueLive.createController`. `module` is undefined there, so the
...
(function () {
    ...
    if (typeof window !== 'undefined') (window.TrueLive = window.TrueLive || {}).createController = createController;
}());
